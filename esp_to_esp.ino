...
#define DHTPIN D5
#undef DEBUG
#define FIREBASE_HOST "https://iot-sensor-9e9d9-default-rtdb.firebaseio.com/"

#define FIREBASE_AUTH "U5bZCqP8QxQcdw9KW2XIk66xANr3dvrKXW7326SU"
FirebaseData fbdo;
...
char ssid[] = "CTD.TNUT";  //  your network SSID (name)
